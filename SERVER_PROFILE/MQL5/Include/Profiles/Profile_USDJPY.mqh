#ifndef PROFILE_USDJPY_INCLUDED
#define PROFILE_USDJPY_INCLUDED

#include "..\\Core\\MbRuntimeTypes.mqh"

void LoadProfileUSDJPY(MbSymbolProfile &out)
  {
