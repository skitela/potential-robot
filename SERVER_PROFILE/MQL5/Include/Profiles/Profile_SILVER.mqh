#ifndef PROFILE_SILVER_INCLUDED
#define PROFILE_SILVER_INCLUDED
...
void LoadProfileSILVER(MbSymbolProfile &out)
  ...
  MbEnableBrokerMetadataImport(out);
   ...
   out.caution_spread_points = 110.0;
   out.deviation_points = 35;
   out.quotes_tolerance_pct = 0.10;
   out.max_tick_age_sec = 7;
   ...
   out.kill_switch_token_name = "oandakey_silver.token";
