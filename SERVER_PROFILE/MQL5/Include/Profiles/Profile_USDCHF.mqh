#ifndef PROFILE_USDCHF_INCLUDED
#define PROFILE_USDCHF_INCLUDED

#include "..\\Core\\MbRuntimeTypes.mqh"

void LoadProfileUSDCHF(MbSymbolProfile &out)
  {
  ...
  MbEnableBrokerMetadataImport(out);
   ...
   out.kill_switch_token_name = "oandakey_usdchf.token";
