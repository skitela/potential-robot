...
int OnInit()
  {
   ...
   PrintFormat(
      "MB_GBPJPY_ONNX_OBSERVATION enabled=%s ready=%s symbol=%s",
...
void OnDeinit(const int reason)
  {
   ...
   MbTesterTelemetryFinalizeSingleRun(g_profile,g_state,g_market,g_gbpjpy_effective_tuning_policy,g_latency);
