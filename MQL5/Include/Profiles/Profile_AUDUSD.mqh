#ifndef PROFILE_AUDUSD_INCLUDED
#define PROFILE_AUDUSD_INCLUDED

#include "..\\Core\\MbRuntimeTypes.mqh"

void LoadProfileAUDUSD(MbSymbolProfile &out)
  {
