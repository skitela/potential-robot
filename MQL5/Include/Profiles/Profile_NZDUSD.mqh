#ifndef PROFILE_NZDUSD_INCLUDED
#define PROFILE_NZDUSD_INCLUDED

#include "..\\Core\\MbRuntimeTypes.mqh"

void LoadProfileNZDUSD(MbSymbolProfile &out)
  {
   ...
   out.kill_switch_token_name = "oandakey_nzdusd.token";
