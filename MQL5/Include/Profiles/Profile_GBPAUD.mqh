#ifndef PROFILE_GBPAUD_INCLUDED
#define PROFILE_GBPAUD_INCLUDED

#include "..\\Core\\MbRuntimeTypes.mqh"

void LoadProfileGBPAUD(MbSymbolProfile &out)
  {
   MbSymbolProfileReset(out);
   out.symbol = "GBPAUD";
   out.trade_tf = PERIOD_M5;
   out.max_spread_points = 52.0;
   out.caution_spread_points = 40.0;
   ...
   out.kill_switch_token_name = "oandakey_gbpaud.token";
