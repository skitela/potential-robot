#ifndef PROFILE_US500_INCLUDED
#define PROFILE_US500_INCLUDED

#include "..\\Core\\MbRuntimeTypes.mqh"

void LoadProfileUS500(MbSymbolProfile &out)
  {
   MbSymbolProfileReset(out);
  MbEnableBrokerMetadataImport(out);
   out.symbol = "US500.pro";
   out.trade_tf = PERIOD_M5;
   out.max_spread_points = 95.0;
   out.caution_spread_points = 60.0;
   ...
   out.session_profile = "INDEX_US";
   out.trade_window_start_hour = 17;
   out.trade_window_end_hour = 20;
   out.friday_cutoff_enabled = true;
   out.friday_cutoff_hour = 21;
   out.kill_switch_required = true;
   out.kill_switch_token_name = "oandakey_us500.token";
