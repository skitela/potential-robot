...
from mb_ml_core.adapter import build_broker_net_ledger
from mb_ml_core.paths import CompatPaths


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Buduje ledger broker-net PLN 1:1 dla MAKRO_I_MIKRO_BOT.")
...
def main() -> int:
    ...
    _, summary = build_broker_net_ledger(paths)
