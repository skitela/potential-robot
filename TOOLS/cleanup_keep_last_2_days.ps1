...
foreach ($target in $targets) {
    ...
    Remove-OldFilesInTree -BasePath $target -Cutoff $cutoff -SkipPredicate $skipPredicate -DeletedRows ([ref]$deleted) -TrackedPaths $gitTracked -SkippedTrackedRows ([ref]$skippedTracked)
}
