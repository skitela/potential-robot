...
class ConsistencyGuardianAgent(ReadOnlyAgentBase):
    ...
    def run_cycle(self) -> dict[str, str | None]:
        ...
        all_findings = {
            ...
            "config_live_scope": {"status": "NOT_CHECKED_IN_DRAFT"},
            "reason_codes": {"status": "NOT_CHECKED_IN_DRAFT"},
            "report_vs_repo": {"status": "NOT_CHECKED_IN_DRAFT"},
            "tech_debt_candidates": {"status": "NOT_CHECKED_IN_DRAFT"},
        }
